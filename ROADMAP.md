...
| 4.2 アクション | 🟡 | §4.2.1 C&C アクションは実装済（Activate a / Runner f-h / 網載せ替え j / 電話線修理 k / 拾う 4.2.2h）。**移動 §4.2.2・Rally §4.2.3・戦闘 §4.2.4 は未**。**調査済みの実装計画は ACTION_SPEC.md**（Auto/ドローの4類型・着手順 Rally→移動→戦闘・各アクションのコスト/Draw表つき） |
